...
import com.guods.contact.F19louAParser;
 ...
 *
 */
public class F19louAView extends JFrame {
	...
	public F19louAView() throws HeadlessException {
		super("19楼数据采集A");
		//初始化组件
		initElements();
		//设置页面
	...
	private void initElements() {
		...
		preUrl.setText("http://www.19lou.com/r/1/hzzxzgr-");
		postUrl = new JTextField(20);
		postUrl.setText(".html?sortby=subscribed");
	...
	public void startWork(int fromPage, int endPage, String preUrl, String postUrl, String filePath, String fileName) {
		...
		// 创建一个解析器
		Parser parser = new F19louAParser();
		stop = false;
		// 修改页码拼接请求，一次循环处理一个页面
